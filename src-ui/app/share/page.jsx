              ...
              <CardBody>
                <div className="w-full flex flex-col gap-4">
                  <div className="flex w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4">
                    <Input type="number" label="Port" onValueChange={handlePortChange} value={port}/>
                  </div>
                  <div className="flex w-full flex-wrap md:flex-nowrap mb-6 md:mb-0 gap-4">
                    <Input type="password" label="Password" onValueChange={handlePasswordChange} value={password}/>
                  </div>
                </div>
              </CardBody>
              <Divider />
              <CardFooter>
                <Button className="py-2 w-full" color="primary" onClick={() => onServerButtonClick()}>
